        ...
        <>
            <div className='w-full h-screen border-b-2 border-gray-600 flex justify-center items-center p-4 md:p-8'>
                <div className='z-50 flex flex-col items-start'>
                    <h1 className='text-white font-black text-3xl sm:text-4xl md:text-5xl sm:ml-0 md:ml-3'>HEY, I'M</h1>
                    ...
                    <div className='flex flex-col flex-wrap md:flex-row md:gap-5 items-start md:items-center'>
                        <h1 className='text-5xl sm:text-6xl md:text-[8rem] leading-tight sm:leading-tight md:leading-[7rem] text-white font-black tracking-tight md:-tracking-widest'>
                            PRAVEEN
                        </h1>
                        <h1 className='text-5xl sm:text-6xl md:text-[8rem] leading-tight sm:leading-tight md:leading-[7rem] text-white font-black tracking-tight md:-tracking-widest'>
                            PASUPULETI
